...
export default function EditVoucherPage() {
    ...
    useEffect(() => {
        ...
        const loadVoucher = async () => {
            ...
            if (res.success && res.data) {
                ...
                setFetchError(res.error || 'Không tìm thấy voucher');
            }
            setIsLoading(false);
        };
    ...
    const handleSubmit = async (payload: AdminVoucherCreateRequest) => {
        ...
        if (result.success) {
            success('Đã cập nhật voucher thành công');
            router.push('/admin/vouchers');
        } else {
            error(result.error || 'Đã xảy ra lỗi khi cập nhật voucher');
        ...
        return (
            <div className="p-6 max-w-3xl mx-auto">
                <div className="bg-red-50 border border-red-100 rounded-xl p-8 text-center flex flex-col items-center">
                    ...
                    <h2 className="text-lg font-bold text-slate-900 mb-2">Không thể tải voucher</h2>
