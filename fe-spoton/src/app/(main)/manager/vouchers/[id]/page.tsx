...
export default function ManagerEditVoucherPage() {
        ...
        return (
            <div className="p-6 max-w-3xl mx-auto">
                <div className="bg-red-50 border border-red-100 rounded-xl p-8 text-center flex flex-col items-center">
                    ...
                    <Link href="/manager/vouchers" className="px-4 py-2 bg-slate-900 text-white rounded-lg font-medium hover:bg-slate-800 transition-colors">
                        Quay lại danh sách
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="p-6">
            <VoucherForm initialData={voucher} onSubmit={handleSubmit} basePath="/manager/vouchers" role="MANAGER" />
        </div>
    );
}
