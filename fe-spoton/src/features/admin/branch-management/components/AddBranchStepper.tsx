  ...
  return (
    <div className="flex items-center justify-center mb-10 w-full max-w-lg mx-auto">
      ...
      <div className="flex flex-col items-center relative">
        ...
        <span className={`font-semibold text-sm mt-2 absolute top-12 whitespace-nowrap ${currentStep >= 1 ? 'text-amber-600' : 'text-gray-400'}`}>Branch Info</span>
      </div>
      ...
      <div className="flex flex-col items-center relative">
        ...
        <span className={`font-semibold text-sm mt-2 absolute top-12 whitespace-nowrap ${currentStep >= 2 ? 'text-amber-600' : 'text-gray-400'}`}>Operations</span>
      </div>
      ...
      <div className="flex flex-col items-center relative">
        ...
        <span className={`font-semibold text-sm mt-2 absolute top-12 whitespace-nowrap ${currentStep >= 3 ? 'text-amber-600' : 'text-gray-400'}`}>Photos</span>
      </div>
    </div>
  );
}
