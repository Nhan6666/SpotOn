  ...
  return (
    <div className="flex flex-col h-full bg-[#f8fafc]">
      ...
      <div className="px-8 py-4 flex items-center text-sm border-b border-gray-100 bg-white">
        ...
        <span className="text-[#e67e22] font-bold">Thêm món mới</span>
      </div>
        ...
        <div className="max-w-[1000px] mx-auto w-full px-8 py-8">
          ...
          <div className="flex justify-between items-start mb-10">
            <div>
              {currentStep === 3 ? (
              <>
                  <h1 className="text-[28px] font-bold text-[#0f172a] tracking-tight">Bước 3: Hình ảnh & Xem lại</h1>
                  <p className="text-[15px] text-[#64748b] mt-1">Hoàn thiện hình ảnh và kiểm tra cấu hình trước khi xuất bản.</p>
                </>
              ) : (
                <>
                  <h1 className="text-[28px] font-bold text-[#0f172a] tracking-tight">Thêm món mới</h1>
                  <p className="text-[15px] text-[#64748b] mt-1">Tạo món ăn hoặc sản phẩm mới cho thực đơn của bạn.</p>
                </>
              )}
            </div>
