      ...
      <div className="flex w-full flex-col justify-center px-8 md:w-1/2 md:px-16 lg:px-24 xl:px-32 relative">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mt-8">
            ...
            <button 
              type="button" 
              className="flex w-full items-center justify-center cursor-pointer gap-2 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors"
            >
