...
export function MapBottomBar({ selectedTableId, selectedTableNumber }: MapBottomBarProps) {
  return (
        ...
        <div className="flex items-center gap-8">
          <div>
            ...
            <div className={`text-lg font-bold ${selectedTableId ? 'text-red-600' : 'text-gray-400'}`}>
              {selectedTableId ? `Bàn số ${selectedTableNumber || selectedTableId}` : 'Chưa chọn bàn'}
            </div>
          </div>
