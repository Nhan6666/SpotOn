  ...
  return (
    <section className="container mx-auto px-4 py-16">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 font-playfair tracking-tight">Ưu Đãi Đặc Biệt</h2>
          <p className="text-gray-500 text-sm">Những khuyến mãi độc quyền cho bữa ăn tiếp theo của bạn.</p>
        </div>
        <Link href="/offers" className="text-amber-500 hover:text-amber-600 text-sm font-medium flex items-center transition-colors">
          Xem tất cả ưu đãi <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#e68a1a] rounded-2xl p-8 text-white relative overflow-hidden group h-full flex flex-col justify-between items-start shadow-md">
          ...
          <div>
            <div className="bg-white bg-opacity-20 backdrop-blur-sm text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4 inline-block">THỜI GIAN CÓ HẠN</div>
            <h3 className="text-2xl font-bold mb-2">Giảm 20% Set Menu</h3>
            <p className="text-white text-opacity-90 text-sm mb-6 max-w-[85%]">
              Áp dụng tại chi nhánh Downtown Prime cho nhóm từ 4 khách.
            </p>
          </div>
        ...
        <div className="bg-[#3e5f48] rounded-2xl p-8 text-white relative overflow-hidden group h-full flex flex-col justify-between items-start shadow-md">
          ...
          <div>
            <div className="bg-white bg-opacity-20 backdrop-blur-sm text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4 inline-block">THÀNH VIÊN MỚI</div>
            <h3 className="text-2xl font-bold mb-2">Tặng Món Tráng Miệng</h3>
            <p className="text-white text-opacity-90 text-sm mb-6 max-w-[85%]">
              Đăng ký và nhận ngay món tráng miệng miễn phí cho lần đặt bàn đầu tiên.
            </p>
          </div>
        ...
        <div className="bg-[#2a2f3a] rounded-2xl p-8 text-white relative overflow-hidden group h-full flex flex-col justify-between items-start shadow-md">
          ...
          <div>
             <div className="bg-white bg-opacity-20 backdrop-blur-sm text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4 inline-block">DỊCH VỤ TIỆC</div>
             <h3 className="text-2xl font-bold mb-2">Miễn phí thiết lập</h3>
             <p className="text-white text-opacity-90 text-sm mb-6 max-w-[85%]">
               Miễn phí thiết lập cao cấp cho sự kiện từ 500$.
             </p>
          </div>
