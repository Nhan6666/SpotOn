  ...
  return (
    <section className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-4 font-playfair tracking-tight">{whyChoose.title}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-2xl p-8 text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-50 transition-transform duration-300 hover:-translate-y-2">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-3">{whyChoose.features[0].title}</h3>
        ...
        <div className="bg-white rounded-2xl p-8 text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-50 transition-transform duration-300 hover:-translate-y-2">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-3">{whyChoose.features[1].title}</h3>
          <p className="text-gray-500 text-sm leading-relaxed">
        ...
        <div className="bg-white rounded-2xl p-8 text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-50 transition-transform duration-300 hover:-translate-y-2">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-3">{whyChoose.features[2].title}</h3>
          <p className="text-gray-500 text-sm leading-relaxed">
