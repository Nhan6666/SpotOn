...
import { History, Eye, Save, Shield, CreditCard, Info, ArrowRight } from 'lucide-react';
    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3 self-start flex-wrap">
          ...
          <Button
            variant="outline"
            className="gap-2 bg-white border-green-600 text-green-700 hover:bg-green-50 hover:text-green-800"
          >
          ...
          <Button
            variant="ghost"
            disabled
            className="gap-2 bg-gray-100 text-gray-400 cursor-not-allowed hover:bg-gray-100"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            ...
            <div className="flex justify-end">
              <button className="flex items-center gap-1.5 text-sm font-semibold text-amber-600 hover:text-amber-700 transition-colors group">
                Configure
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            ...
            <hr className="my-4 border-gray-100" />
            <div className="flex justify-end">
              <button className="flex items-center gap-1.5 text-sm font-semibold text-emerald-700 hover:text-emerald-800 transition-colors group">
                Configure
                <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
              </button>
            </div>
